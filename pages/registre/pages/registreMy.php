...
<head>
    ...
    <title>Registre mon événement</title>
...
$ticketID=$_SESSION['id_ticket'];
$_SESSION['raand']=rand(3080131,9080131);
$nbrand=$_SESSION['raand'];



  if (isset($_POST['ikhan'])) {

    $ins_req = "insert into reserve values($idParticip,$ticketID,$quantity,$nbrand)";
